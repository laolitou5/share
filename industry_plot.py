...
def main(start_time, end_time, tm, indu, ktype):
    ...
    #申万一级各个行业北向资金流动图
    # D.bx_in_out('20210222', '20210305')
    # exit(-1)
    # D.bx_in_out_indu('20210201', '20210218')
    # exit(-1)
    #根据最新的行业北向资金变化获得codes
    df_s = pd.read_csv('data/2021-03-05_new.csv', converters={'code': str})
    k = D.shenwan_industry_code(df_s, '建筑装饰')
    # exit(-1)
...
if __name__ == '__main__':
    ...
    main('19900101', '20210223', '20201201', '通信', 'D')
    # main()
    # import numpy as np
